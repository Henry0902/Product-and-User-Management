...
<%--                    <!-- Product image-->--%>
<%--                    <img src="${item.imageName}" alt="${item.productName}" class="img-fluid rounded-3" >--%>
<%--                    <!-- Product details-->--%>
            ...
            <c:forEach items="${productInfos}" var="item" varStatus="status">
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product image-->
                        <img src="${pageContext.request.contextPath}/img/product/${item.imageName}" alt="${item.productName}" class="card-img-top">
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
